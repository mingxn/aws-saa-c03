---
title: "A security audit reveals that Amazon EC2 instances are not b..."
draft: false
categories:
  - EC2
  - Compute
...
difficulty: "medium"
question: "A security audit reveals that Amazon EC2 instances are not being patched regularly. A solutions architect needs to provide a solution that will run regular security scans across a large fleet of EC2 instances. The solution should also patch the EC2 instances on a regular schedule and provide a report of each instance’s patch status. Which solution will fulfill these requirements?"
options:
