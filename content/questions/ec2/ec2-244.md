---
title: "A company is using a content management system that runs on ..."
draft: false
categories:
  - EC2
  - Compute
...
difficulty: "medium"
question: "A company is using a content management system that runs on a single Amazon EC2 instance. The EC2 instance contains both the web server and the database software. The company must make its website platform highly available and must enable the website to scale to fulfill user demand. What should a solutions architect recommend to fulfill these requirements?"
options:
...
answer: "C"
explanation: "This option provides both high availability and scalability. Using Amazon Aurora with a read replica in another Availability Zone ensures data redundancy and failover capabilities. Configuring an Application Load Balancer across two Availability Zones and using Auto Scaling allows for scalability."
tags:
  - ec2
  - compute
---
