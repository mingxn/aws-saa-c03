---
title: "A company runs multiple Amazon EC2 Linux instances in a VPC ..."
draft: false
categories:
  - EC2
  - Compute
...
difficulty: "medium"
question: "A company runs multiple Amazon EC2 Linux instances in a VPC across two Availability Zones. The instances host applications that use a hierarchical directory structure. The applications need to read and write rapidly and concurrently to shared storage. What should a solutions architect do to fulfill these requirements?"
options:
