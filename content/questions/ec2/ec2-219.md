---
title: "A company’s application is having performance issues. The ap..."
draft: false
categories:
  - EC2
  - Compute
...
options:
  ...
  C: "Modify the CloudFormation templates. Replace the EC2 instances with R5 EC2 instances. Use Amazon CloudWatch built-in EC2 memory metrics to traffick the application performance for future capacity planning."
