---
title: "A company wants to build a web application on AWS. Client ac..."
draft: false
categories:
  - EBS
  - Storage
...
options:
  ...
  D: "Create an Amazon Cognito identity pool to authenticate users. E. Use AWS Amplify to serve the frontend web content with HTML, CSS, and JS. Use an integrated Amazon CloudFront conguration. F. Use Amazon S3 static web hosting with PHP, CSS, and JS. Use Amazon CloudFront to serve the frontend web content."
answer: ""
explanation: ""
tags:
  - ebs
