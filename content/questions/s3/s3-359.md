---
title: "A hospital needs to store patient records in an Amazon S3 bu..."
draft: false
categories:
  - S3
  - Storage
...
difficulty: "medium"
question: "A hospital needs to store patient records in an Amazon S3 bucket. The hospital’s compliance team must ensure that all protected health information (PHI) is encrypted in transit and at rest. The compliance team must administer the encryption key for data at rest. Which solution will fulfill these requirements?"
options:
