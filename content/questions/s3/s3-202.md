---
title: "A company is planning to move its data to an Amazon S3 bucke..."
draft: false
categories:
  - S3
  - Storage
...
difficulty: "medium"
question: "A company is planning to move its data to an Amazon S3 bucket. The data must be encrypted when it is stored in the S3 bucket. Additionally, the encryption key must be automatically rotated every year. Which solution will fulfill these requirements with the LEAST operational overhead?"
options:
