---
title: "A retail company uses a regional Amazon API Gateway API for ..."
draft: false
categories:
  - Route53
  - Networking
...
difficulty: "medium"
question: "A retail company uses a regional Amazon API Gateway API for its public REST APIs. The API Gateway endpoint is a custom domain name that points to an Amazon Route 53 alias record. A solutions architect needs to create a solution that has minimal effects on customers and minimal data loss to release the new version of APIs. Which solution will fulfill these requirements?"
options:
