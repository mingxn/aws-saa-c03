---
title: "A company is planning to migrate a TCP-based application int..."
draft: false
categories:
  - VPC
  - Networking
...
difficulty: "medium"
question: "A company is planning to migrate a TCP-based application into the company's VPC. The application is publicly accessible on a nonstandard TCP port through a hardware appliance in the company's data center. This public endpoint can process up to 3 million requests per second with low latency. The company requires the same level of performance for the new public endpoint in AWS. What should a solutions architect recommend to fulfill this requirement?"
options:
