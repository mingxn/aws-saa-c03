---
title: "A company is developing a microservices application that wil..."
draft: false
categories:
  - VPC
  - Networking
...
difficulty: "medium"
question: "A company is developing a microservices application that will provide a search catalog for customers. The company must use REST APIs to present the frontend of the application to users. The REST APIs must access the backend services that the company hosts in containers in private VPC subnets. Which solution will fulfill these requirements?"
options:
