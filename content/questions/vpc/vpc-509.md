---
title: "A global marketing company has applications that run in the ..."
draft: false
categories:
  - VPC
  - Networking
...
difficulty: "medium"
question: "A global marketing company has applications that run in the ap-southeast-2 Region and the eu-west-1 Region. Applications that run in a VPC in eu- west-1 need to communicate securely with databases that run in a VPC in ap-southeast-2. Which network design will fulfill these requirements?"
options:
