---
title: "A company has an application that is backed by an Amazon Dyn..."
draft: false
categories:
  - DynamoDB
  - Database
...
difficulty: "medium"
question: "A company has an application that is backed by an Amazon DynamoDB table. The company’s compliance requirements specify that database backups must be taken every month, must be available for 6 months, and must be retained for 7 years. Which solution will fulfill these requirements?"
options:
