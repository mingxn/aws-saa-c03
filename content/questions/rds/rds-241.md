---
title: "An online learning company is migrating to the AWS Cloud. Th..."
draft: false
categories:
  - RDS
  - Database
...
difficulty: "medium"
question: "An online learning company is migrating to the AWS Cloud. The company maintains its student records in a PostgreSQL database. The company needs a solution in which its data is available and online across multiple AWS Regions at all times. Which solution will fulfill these requirements with the LEAST amount of operational overhead?"
options:
