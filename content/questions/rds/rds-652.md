---
title: "A company maintains an Amazon RDS database that maps users t..."
draft: false
categories:
  - RDS
  - Database
...
difficulty: "medium"
question: "A company maintains an Amazon RDS database that maps users to cost centers. The company has accounts in an organization in AWS Organizations. The company needs a solution that will tag all resources that are created in a specific AWS account in the organization. The solution must tag each resource with the cost center ID of the user who created the resource. Which solution will fulfill these requirements?"
options:
