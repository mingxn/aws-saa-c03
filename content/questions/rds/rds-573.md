---
title: "A financial services company launched a new application that..."
draft: false
categories:
  - RDS
  - Database
...
difficulty: "medium"
question: "A financial services company launched a new application that uses an Amazon RDS for MySQL database. The company uses the application to traffick stock market trends. The company needs to operate the application for only 2 hours at the end of each week. The company needs to optimize the cost of running the database. Which solution will fulfill these requirements MOST cost-effectively?"
options:
